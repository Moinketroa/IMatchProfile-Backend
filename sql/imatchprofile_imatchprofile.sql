...
CREATE TABLE `user` (
  ...
  KEY `fk_user_candidate_idx` (`sub_user_id`),
  CONSTRAINT `fk_user_candidate` FOREIGN KEY (`sub_user_id`) REFERENCES `candidate` (`candidate_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_moderator` FOREIGN KEY (`sub_user_id`) REFERENCES `moderator` (`moderator_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_user_recruiter` FOREIGN KEY (`sub_user_id`) REFERENCES `recruiter` (`recruiter_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-12-08 18:37:22
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: imatchprofile
-- ------------------------------------------------------
...
-- Dump completed on 2017-12-08 18:37:23
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: imatchprofile
-- ------------------------------------------------------
